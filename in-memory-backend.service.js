...
export var InMemoryBackendService = (function () {
  ...
  InMemoryBackendService.prototype.prepareResponseBody = function (data) {
    if (this.config.wrapResponseData) {
  ...
  InMemoryBackendService.prototype.get = function (_a) {
    ...
    return new ResponseOptions({
      body: this.prepareResponseBody(data),
      headers: headers,
      status: STATUS.OK
    });
  };
  ...
  InMemoryBackendService.prototype.post = function (_a) {
    ...
    var body = this.prepareResponseBody(data);
    if (existingIx > -1) {
  ...
  /** @nocollapse */
  InMemoryBackendService.ctorParameters = function () {
    return [
      { type: Injector, },
